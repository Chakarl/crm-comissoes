      ...
      <div className="bg-gray-900 rounded-xl shadow-2xl p-8 w-full max-w-md">
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-blue-600 hover:bg-blue-500 disabled:bg-gray-700 disabled:cursor-not-allowed text-white font-semibold py-3 rounded-lg transition"
          >
        ...
        <div className="mt-6 p-4 bg-gray-800 rounded-lg">
          <p className="text-xs text-gray-400 text-center">
            <strong>Acesso Master:</strong><br />
            Email: master@crm.com<br />
            Senha: master123
          </p>
        </div>
      </div>
